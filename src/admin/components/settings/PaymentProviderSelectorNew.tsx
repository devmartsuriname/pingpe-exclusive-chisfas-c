...
export default function PaymentProviderSelectorNew() {
              ...
              <FormControl>
                ...
                >
                  <div className="flex items-center space-x-3 space-y-0">
                    <RadioGroupItem value="wise" id="wise-pay" />
                    <label
                      htmlFor="wise-pay"
                      className="font-normal cursor-pointer"
                    >
                      Wise (Recommended for Suriname)
                    </label>
                  </div>
                  <div className="flex items-center space-x-3 space-y-0">
                    <RadioGroupItem value="paypal" id="paypal-pay" />
                    <label
                      htmlFor="paypal-pay"
                      className="font-normal cursor-pointer"
                    >
                  ...
                  <div className="flex items-center space-x-3 space-y-0">
                    <RadioGroupItem value="stripe" id="stripe-pay" disabled />
                    <label
                      htmlFor="stripe-pay"
                      className="font-normal cursor-not-allowed text-muted-foreground"
                    >
                      Stripe (Coming Soon)
                    </label>
                  </div>
